...
const optionalPaths = ["/market", "/market/sources", "/regime", "/signals", "/strategies", "/risk", "/margin", "/reviews", "/daily-reviews", "/learning", "/exchange/okx/status", "/exchange-health", "/version", "/llm/decisions", "/trade-plans", "/trade-episodes", "/llm/health"] as const;
