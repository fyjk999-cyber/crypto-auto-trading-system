...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.UniqueConstraint(
            "account_id", "currency", name="uq_accounts_projection_account_currency"
        ),
    )
    op.create_table(
        "audit_events",
    ...
    op.create_index(
        op.f("ix_audit_events_audit_event_id"), "audit_events", ["audit_event_id"], unique=False
    )
    op.create_table(
        "engine_runs",
    ...
    op.create_index(
        op.f("ix_ledger_transactions_entry_type"),
        "ledger_transactions",
        ["entry_type"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_market_snapshots_symbol"), "market_snapshots", ["symbol"], unique=False
    )
    op.create_table(
        "orders",
    ...
    op.create_index(
        op.f("ix_reconciliation_runs_run_id"), "reconciliation_runs", ["run_id"], unique=False
    )
    op.create_table(
        "risk_decisions",
    ...
    op.create_index(
        op.f("ix_risk_decisions_client_order_id"),
        "risk_decisions",
        ["client_order_id"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_ledger_entries_transaction_seq",
        "ledger_entries",
        ["transaction_id", "seq"],
        unique=False,
    )
