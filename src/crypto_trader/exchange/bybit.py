...
class BybitAdapter(ExchangeAdapter):
    ...
    async def _not_implemented(self, method: str):
        raise NotImplementedError(f"Bybit adapter {method} is a phase-1 boundary")
    ...
    def normalize_order(self, raw: dict):
        raise NotImplementedError("Bybit normalize_order is a phase-1 boundary")

    def normalize_fill(self, raw: dict):
        raise NotImplementedError("Bybit normalize_fill is a phase-1 boundary")
