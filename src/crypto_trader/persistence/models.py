...
class TradePlanORM(Base):
    ...
    supporting_evidence: Mapped[list[Any] | None] = mapped_column(JSON, nullable=True)
    contradicting_evidence: Mapped[list[Any] | None] = mapped_column(JSON, nullable=True)
    invalidation_conditions: Mapped[list[Any] | None] = mapped_column(JSON, nullable=True)
    target_conditions: Mapped[list[Any] | None] = mapped_column(JSON, nullable=True)
    ...
    memory_refs: Mapped[list[Any] | None] = mapped_column(JSON, nullable=True)
