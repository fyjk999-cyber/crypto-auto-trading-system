...
_TRANSITIONS: dict[tuple[OrderStatus, OrderEventType], OrderStatus] = {
    ...
    (OrderStatus.ACKNOWLEDGED, OrderEventType.ORDER_CANCELLED): OrderStatus.CANCELLED,
    ...
    (OrderStatus.OPEN, OrderEventType.ORDER_CANCELLED): OrderStatus.CANCELLED,
    ...
    (OrderStatus.PARTIALLY_FILLED, OrderEventType.ORDER_CANCELLED): OrderStatus.CANCELLED,
