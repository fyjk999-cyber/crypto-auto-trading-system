/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 193b7ac6a7e2bdf35e8ce0e07b64b0e0)
...
interface __BaseEnv_Env {
	...
	TRADING_CONTAINER: DurableObjectNamespace<import("./src/index").TradingContainerV2>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "TradingContainer" | "TradingContainerV2";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "TRADING_MODE" | "PAPER_MODE" | "AUTO_START_RUNTIME" | "LIVE_TRADING_ENABLED" | "BINANCE_TESTNET">> {}
}
